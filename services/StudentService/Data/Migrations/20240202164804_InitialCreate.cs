        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentCode = table.Column<string>(type: "character varying(12)", maxLength: 12, nullable: true),
                    ...
                    Faculty = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenAttendanceTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CloseAttendanceTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Bluetooth = table.Column<string>(type: "jsonb", nullable: true),
                    Wifi = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_AttendedTime",
                table: "Attendances",
                column: "AttendedTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_DateEnd",
                table: "Subjects",
                column: "DateEnd");

            migrationBuilder.CreateIndex(
                name: "IX_Subjects_DateStart",
                table: "Subjects",
                column: "DateStart");

            migrationBuilder.CreateIndex(
                name: "IX_Subjects_Room",
                table: "Subjects",
                column: "Room");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_UpdatedAt",
                table: "Subjects",
                column: "UpdatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Teachers_CreatedAt",
                table: "Teachers",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Teachers_UpdatedAt",
                table: "Teachers",
                column: "UpdatedAt");
        }
